                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <label>
                                                ...
                                                <label>
                                                    <p>Længde:</p>
                                                    <input type="number" class="form-control" name="shedLength" placeholder="Cm" min="210" max="750" required>
                                                </label>
                                                <br>
                                                <label>
                                                    <p>Bredde:</p>
                                                    <input type="number" class="form-control" name="shedWidth" placeholder="Cm" min="210" max="720" required>
                                                </label>
                                            </label>
                                        </th>
                                    </tr>
