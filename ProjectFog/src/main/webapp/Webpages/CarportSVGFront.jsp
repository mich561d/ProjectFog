...
<html>
    ...
    <body>
        ...
        <!--Carport frontareal-->
        <rect x="25" y="100" height="200" width="650" stroke="black" style="fill: lightgrey"/>
        <!--spær-->
        ...
        <!--vandbrædder sider-->
        <rect x="23.1" y="85" height="10" width="1.9" stroke="black" style="fill:white"/>
        <rect x="675" y="85" height="10" width="1.9" stroke="black" style="fill:white"/>
        <!--vandbrædder front og bagende-->
        <rect x="25" y="85" height="10" width="650" stroke="black" style="fill:white"/>
    </body>
</html>
